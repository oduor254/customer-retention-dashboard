...
Short description
-----------------
This repository contains Python scripts and simple templates used to analyze customer retention and verify data quality from an API and cached CSVs. It includes utilities for inspecting columns, validating API responses, and running quick retention logic checks.
